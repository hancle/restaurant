...
public class DataService {
    ...
    private static final String BASE_HOSTNAME = "192.168.6.1";
    private static final String BASE_PORT = "8080";
    private static final String BASE_URL = "http://" + BASE_HOSTNAME + ":" + BASE_PORT + "/WebProject1/";
    ...
    public List<Restaurant> getNearbyRestaurants() {
        String[] request = {"GetRestaurantsNearby", "30.0", "20.0"};
        ...
        try {
            for (int i = 0; i < response.length(); i++) {
                ...
                if (business != null) {
                    ...
                    String type = business.getJSONArray("categories").getString(0);
                    ...
                    restaurants.add(
                            new Restaurant(businessId, name, address, type, lat, lng));
                }
            }
            return restaurants;
